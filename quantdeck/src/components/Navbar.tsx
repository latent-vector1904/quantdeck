...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 h-[60px] bg-bg border-b border-border flex items-center px-10 gap-4">
      <button
      ...
      >
        ...
        <span className="text-[18px] font-bold tracking-tight">QuantDeck</span>
      </button>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <button
          ...
          title="Settings"
          className="w-9 h-9 rounded-lg border border-border text-text-faint flex items-center justify-center hover:text-text-dim hover:border-bg-accent transition-all"
        >
